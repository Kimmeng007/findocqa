...
st.markdown(
    ...
    "- **Agent tool-calling**: the calculator tool existed but was never "
    "actually reachable by the agent until this was tested and fixed -- "
    "a small, hand-picked agent-level eval (6 FinanceBench questions "
    "needing a derived figure) now shows the tool used correctly on 5/6, "
    "no crashes on 6/6, and task completion at 3/6 -- a real, mixed "
